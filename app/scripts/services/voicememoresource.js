...
/**
 * @ngdoc service
 * @name voiceMemoRsApp.VoicememoResource
 * @description
 * # VoicememoResource
 * Service in the voiceMemoRsApp.
 */
angular.module('voiceMemoRsApp').service('VoicememoResource', function VoicememoResource() {
  ...
  return remoteStorage.voicememos;
